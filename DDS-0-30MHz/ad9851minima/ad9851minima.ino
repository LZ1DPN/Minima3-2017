...
int_fast32_t rxifUSB=20003000;   // + 3000   2500
int_fast32_t rit=300;   //  
...
ISR(PCINT2_vect) {
  ...
  if (result) {    
    if (result == DIR_CW){rx=rx+increment;}
      ...
      if (rx >=130000000){rx=rx2;}; // UPPER VFO LIMIT 
...
void sendFrequency(double frequency) {  
  int32_t freq = ((frequency + rxif) - rit) * 4294967296./180000000;  // note 180 MHz clock on 9851. also note slight adjustment of this can be made to correct for frequency error of onboard crystal
